...
const sliderTemplate = (ctx) => html`
   ...
   <div class="slider-container">
      <input class="slider" type="range" @input=${ctx.sliderInputHandler} value="${ctx.value}" step="${ctx.step}" />
      <div class="slider-end">Percentage: <span class="slider-percentage-value">${ctx.percentage}</span></div>
   </div>
`;
class Slider extends HTMLElement {
   ...
   _update() {
      render(sliderTemplate(this.state), this.root, { eventContext: this });
   }
}
